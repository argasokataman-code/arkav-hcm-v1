...
return new class extends Migration
{
    ...
    private function addForeignKeys(): void
    {
        ...
        $this->safeForeign('report_data_blocks', 'snapshot_uuid', 'report_snapshots', 'uuid', 'report_data_blocks_snapshot_uuid_fk', 'null');
        $this->safeForeign('report_filters', 'snapshot_uuid', 'report_snapshots', 'uuid', 'report_filters_snapshot_uuid_fk', 'null');
        $this->safeForeign('report_exports', 'snapshot_uuid', 'report_snapshots', 'uuid', 'report_exports_snapshot_uuid_fk', 'null');
    }
