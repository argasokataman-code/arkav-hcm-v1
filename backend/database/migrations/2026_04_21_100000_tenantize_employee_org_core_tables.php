...
return new class extends Migration
{
    ...
    {
        $this->addCompanyIdColumn('employee_profiles');
        $this->addCompanyIdColumn('departments');
        $this->addCompanyIdColumn('designations');
        $this->addCompanyIdColumn('teams');

        $this->backfillDefaultCompany('employee_profiles');
        $this->backfillDefaultCompany('departments');
        $this->backfillDefaultCompany('designations');
        $this->backfillDefaultCompany('teams');
    }

    public function down(): void
    {
        $this->dropCompanyIdColumn('teams');
        $this->dropCompanyIdColumn('designations');
        $this->dropCompanyIdColumn('departments');
        $this->dropCompanyIdColumn('employee_profiles');
    }
