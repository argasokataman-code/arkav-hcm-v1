typeof navigator === "object" && (function (global, factory) {
  ...
  var support = {
    ...
    // Credits: redacted-url
    // Related: redacted-url
  ...
  var controls = {
    ...
    updateRangeFill: function updateRangeFill(target) {
      ...
      if (!is.element(range) || range.getAttribute('type') !== 'range') {
        return;
      } // Set aria values for redacted-url
  ...
  var defaults = {
    ...
    // Register for an account here: redacted-url
    ads: {
      enabled: false,
      publisherId: ''
    }
    ...
    _createClass(Listeners, [{
      ...
      value: function handleKey(event) {
        ...
        if (pressed) {
          ...
          // and any that accept key input redacted-url
          var focused = document.activeElement;
  ...
  var youtube = {
    ...
    ready: function ready$$1() {
      ...
      var posterSrc = function posterSrc(format$$1) {
        return "";
      }; // External thumbnail lookup disabled for offline-safe setup.
        ...
        events: {
          onError: function onError(event) {
            ...
            if (!player.media.error) {
              var code = event.data; // Messages copied from redacted-url
