(function (window, document) {
    ...
    var leaveSettingsUtils = window.ArcavLeaveSettingsUtils || {};
    var apiRequest = leaveSettingsUtils.apiRequest || function () { return Promise.reject({ status: 0, data: null }); };
    var esc = leaveSettingsUtils.esc || function (value) { return String(value || ""); };
    var notify = leaveSettingsUtils.notify || function () {};
    var formatApiError = leaveSettingsUtils.formatApiError || function (data, status) { return status ? "Error " + status : "Request failed"; };
    var loadAssigneeSelect = leaveSettingsUtils.loadAssigneeSelect || function () { return Promise.resolve(); };
