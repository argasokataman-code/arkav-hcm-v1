(function (window, document) {
    ...
    var salaryMasterUtils = window.ArcavSalaryComponentMasterUtils || {};
    var apiRequest = typeof salaryMasterUtils.apiRequest === "function" ? salaryMasterUtils.apiRequest : function () { return Promise.reject({ status: 500, data: { message: "Salary component utils not loaded" } }); };
    var esc = typeof salaryMasterUtils.esc === "function" ? salaryMasterUtils.esc : function (v) { return String(v || ""); };
    var notify = typeof salaryMasterUtils.notify === "function" ? salaryMasterUtils.notify : function () {};
    var formatApiError = typeof salaryMasterUtils.formatApiError === "function" ? salaryMasterUtils.formatApiError : function (data, status) { return (data && data.message) || (status ? "Error " + status : "Request failed"); };
    var truncate = typeof salaryMasterUtils.truncate === "function" ? salaryMasterUtils.truncate : function (s) { return String(s || ""); };
    var formatDefaultPercentDisplay = typeof salaryMasterUtils.formatDefaultPercentDisplay === "function" ? salaryMasterUtils.formatDefaultPercentDisplay : function (v) { return String(v || ""); };
    var readPercentPayload = typeof salaryMasterUtils.readPercentPayload === "function" ? salaryMasterUtils.readPercentPayload : function () { return { defaultPercent: null, percentBasis: null }; };
