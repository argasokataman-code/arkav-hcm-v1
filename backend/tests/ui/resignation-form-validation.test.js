...
function buildDom() {
    var fields = ["employee_id","resignation_date"];
    document.body.innerHTML = '<form id="arcav_resignation_modal">' +
...
describe('resignation form validation', function () {
    beforeEach(function () {
    ...
    test('rejects empty required fields', function () {
        var form = document.getElementById('arcav_resignation_modal');
        ...
        var el1 = document.getElementById('resignation_date');
    ...
    test('accepts filled required fields', function () {
        ...
        var el1 = document.getElementById('resignation_date'); if (el1) el1.value = 'test';
        var form = document.getElementById('arcav_resignation_modal');
        var result = window.ArcavValidation.validateForm(form);
