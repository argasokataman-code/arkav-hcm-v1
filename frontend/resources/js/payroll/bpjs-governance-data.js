(function (window, document) {
    'use strict';
    var bpjsUtils = window.ArcavBpjsGovernanceUtils || {};
    var q = bpjsUtils.q || function (sel) { return document.querySelector(sel); };
    var apiRequest = bpjsUtils.apiRequest || function () { return Promise.reject(new Error('BPJS utils not loaded')); };
    var apiGet = bpjsUtils.apiGet || function (path, params) { return apiRequest('GET', path, params); };
    var apiPost = bpjsUtils.apiPost || function (path, payload) { return apiRequest('POST', path, payload); };
    var apiPut = bpjsUtils.apiPut || function (path, payload) { return apiRequest('PUT', path, payload); };
    var apiDelete = bpjsUtils.apiDelete || function (path) { return apiRequest('DELETE', path); };
    var escapeHtml = bpjsUtils.escapeHtml || function (value) { return String(value || ''); };
    var unwrapData = bpjsUtils.unwrapData || function (res) { return res || {}; };
    var boolBadge = bpjsUtils.boolBadge || function (status) { return String(status); };
    var membershipBadge = bpjsUtils.membershipBadge || function (status) { return String(status); };
    var basisLabel = bpjsUtils.basisLabel || function (value) { return String(value || '-'); };
    var programLabel = bpjsUtils.programLabel || function (value) { return String(value || '-'); };
    var partyLabel = bpjsUtils.partyLabel || function (value) { return String(value || '-'); };
    var formatPercent = bpjsUtils.formatPercent || function (value) { return String(value || '-'); };
    var formatDateTime = bpjsUtils.formatDateTime || function (value) { return String(value || '-'); };
    var actionLabel = bpjsUtils.actionLabel || function (value) { return String(value || '-'); };
    var showError = bpjsUtils.showError || function () {};
    var hideError = bpjsUtils.hideError || function () {};
    var getScreen = bpjsUtils.getScreen || function () { return null; };
    ...
    var formatRupiah = bpjsUtils.formatRupiah || function (value) { return String(value || '-'); };
    var salaryCapLabel = bpjsUtils.salaryCapLabel || function () { return '-'; };
