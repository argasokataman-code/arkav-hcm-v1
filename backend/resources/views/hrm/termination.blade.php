...
@section('content')
        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="mb-2">
                        <a href="#" class="btn btn-primary d-flex align-items-center" data-arcav-termination-add><i class="ti ti-circle-plus me-2"></i>Add Termination</a>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table" data-arcav-terminations-table>
                                    ...
                                    <tbody data-arcav-terminations-tbody>
                                        <tr>
    ...
    @include('hcm.partials.termination-modals')
