...
return new class extends Migration
{
    ...
    private function backfillForeignUuids(): void
    {
        ...
        $this->syncUuidByJoin('hcm_user_roles', 'user_id', 'user_uuid', 'users');
        $this->syncUuidByJoin('hcm_user_roles', 'company_id', 'company_uuid', 'companies');
        $this->syncUuidByJoin('hcm_user_roles', 'role_id', 'role_uuid', 'hcm_roles');
        $this->syncUuidByJoin('hcm_user_roles', 'assigned_by_user_id', 'assigned_by_user_uuid', 'users');
    ...
    private function addIndexes(): void
    {
        $indexes = [
            ...
            ['hcm_user_roles', 'user_uuid', 'hcm_user_roles_user_uuid_idx'],
            ['hcm_user_roles', 'company_uuid', 'hcm_user_roles_company_uuid_idx'],
            ['hcm_user_roles', 'role_uuid', 'hcm_user_roles_role_uuid_idx'],
            ['hcm_user_roles', 'assigned_by_user_uuid', 'hcm_user_roles_assigned_by_user_uuid_idx'],
    ...
    private function addForeignKeys(): void
    {
        ...
        $this->safeForeign('hcm_user_roles', 'role_uuid', 'hcm_roles', 'uuid', 'hcm_user_roles_role_uuid_fk', 'cascade');
