...
function dragula (initialContainers, options) {
  ...
  function grab (e) {
    ...
    eventualMovements();
    if (e.type === 'mousedown') {
      if (isInput(item)) { // see also: redacted-url
        item.focus(); // fixes redacted-url
      } else {
        e.preventDefault(); // fixes redacted-url
      }
    }
  }
...
function whichMouseButton (e) {
  ...
  if (e.which !== void 0 && e.which !== 0) { return e.which; } // see redacted-url
  if (e.buttons !== void 0) { return e.buttons; }
  var button = e.button;
  if (button !== void 0) { // see redacted-url
