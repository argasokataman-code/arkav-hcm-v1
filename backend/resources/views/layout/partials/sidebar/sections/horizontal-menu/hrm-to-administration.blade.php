...
@endif
                ...
                <li class="submenu">
                   ...
                   'profile-settings','company-profile','security-settings','notification-settings','business-settings','seo-settings','localization-settings','prefixes','preferences','performance-appraisal','language','authentication-settings','ai-settings',
                    'approval-settings','leave-type','email-settings','cronjob') ? 'active subdrop' : '' }}">
...
@if ($isHcmAdmin && ! $hideTenantOperationalReports)
                        ...
                        <li class="submenu">
                            ...
                            'approval-settings','leave-type','email-settings','cronjob') ? 'active subdrop' : '' }}"><span>Settings</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="submenu">
                                ...
                                @if ($isGlobalHcmAdmin)
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="{{ Request::is('cronjob') ? 'active subdrop' : '' }}">Other Settings<span class="menu-arrow"></span></a>
                                    <ul>
