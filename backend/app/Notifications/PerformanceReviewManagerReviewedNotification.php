...
class PerformanceReviewManagerReviewedNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'event_key' => 'performance.review.manager_reviewed',
            ...
            'manager_total_score' => $this->review->manager_total_score,
