...
<script>
    // Modular entry point loaded via index.js. The legacy bundle is
    // loaded through index.js for bootstrap. Set to `true` to skip
    // the modular wrapper and load legacy directly.
    window.ArcavEmployeesUseLegacy = false;
</script>
