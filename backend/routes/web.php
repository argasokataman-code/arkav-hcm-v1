...
Route::get('/tickets', function (Request $request) {
    ...
    if (in_array($role, ['owner', 'admin', 'hr_admin', 'ops_admin'], true)) {
...
Route::get('/ticket-details', function (Request $request) {
    $role = strtolower(trim((string) $request->attributes->get('activeCompanyRole', '')));
...
Route::get('/overtime-request', function (Request $request) {
    $role = strtolower(trim((string) $request->attributes->get('activeCompanyRole', '')));
