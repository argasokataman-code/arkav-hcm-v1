...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function setupHcmAdminPermissions(User $user, ?Company $company = null): HcmRole
    {
        ...
        $permissionCodes = [
            ...
            'payroll.run' => ['module' => 'payroll', 'resource' => 'payroll', 'action' => 'run'],
            ...
            'payroll.thr.manage' => ['module' => 'payroll', 'resource' => 'thr', 'action' => 'manage'],
            'payroll.pkwt.manage' => ['module' => 'payroll', 'resource' => 'pkwt', 'action' => 'manage'],
