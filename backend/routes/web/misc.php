...
Route::get('/add-invoices', function () {
    return view('finance.add-invoices');
})->name('add-invoices');
Route::get('/edit-invoices', function () {
    return view('finance.edit-invoices');
})->name('edit-invoices');
Route::get('/invoice-details', function () {
    return view('finance.invoice-details');
...
Route::get('/budget-expenses', function () {
    return view('finance.budget-expenses');
})->name('budget-expenses');
Route::get('/budget-revenues', function () {
    return view('finance.budget-revenues');
...
Route::get('/provident-fund', function () {
    return view('finance.provident-fund');
})->name('provident-fund');
...
Route::get('/shortlist-candidates', function () {
    return view('recruitment.shortlist-candidates');
})->name('shortlist-candidates');
Route::get('/offer-approvals', function () {
    return view('recruitment.offer-approvals');
...
Route::get('/terms-condition', function () {
    return view('misc.terms-condition');
...
Route::get('/search-result', function () {
    return view('misc.search-result');
})->name('search-result');
Route::get('/gallery', function () {
    return view('misc.gallery');
})->name('gallery');
Route::redirect('/profile', '/profile-settings', 301)->name('profile');
Route::get('/starter', function () {
    return view('misc.starter');
})->name('starter');
