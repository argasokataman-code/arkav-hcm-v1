...
(function (global, factory) {
   ...
   *
   * - IE Compatibility Issue: redacted-url
   * - Scroll Issue: redacted-url
   *
   * @param {Rect} rect
  ...
  */
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.createVideoNode = function (url) {
          ...
          if (ytMatch && ytMatch[1].length === 11) {
              ...
              $video = $$1('<iframe>')
                  .attr('frameborder', 0)
                  .attr('src', 'redacted-url' + igMatch[1] + '/embed/')
              ...
              $video = $$1('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
                  ...
                  .attr('height', '310')
                  .attr('width', '500')
                  .attr('src', 'redacted-url' + vid + '&amp;auto=0');
          }
  ...
  var HelpDialog = /** @class */ (function () {
      ...
      HelpDialog.prototype.initialize = function () {
          ...
          var body = [
              '<p class="text-center">',
              '<a href="redacted-url" target="_blank">Summernote 0.8.11</a> · ',
              '<a href="redacted-url" target="_blank">Project</a> · ',
              '<a href="redacted-url" target="_blank">Issues</a>',
              '</p>'
          ].join('');
          this.$dialog = this.ui.dialog({
