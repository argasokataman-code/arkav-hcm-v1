...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('hcm_roles') && Schema::hasTable('companies') && Schema::hasColumn('companies', 'uuid')) {
        ...
        if (Schema::hasTable('hcm_user_role_audits')) {
        ...
        if (Schema::hasTable('hcm_schedule_timings')) {
