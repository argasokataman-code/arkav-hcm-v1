...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <!-- Training list (shell; rendered by JS) -->
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-2">
                        ...
                        <div class="input-icon-start me-2">
                            ...
                            <input type="text" class="form-control" placeholder="Search trainer/desc..." data-arcav-training-q>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody data-arcav-trainings-tbody>
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">Memuat trainings...</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
